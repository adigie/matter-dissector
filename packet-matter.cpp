...
static bool MatterExchangeFilter_IsValid(struct _packet_info *pinfo, void*)
{
    return proto_is_frame_protocol(pinfo->layers, "matter") && MatterMessageTracker::FindMessageRecord(pinfo) != NULL;
}

static gchar* MatterExchangeFilter_BuildFilterString(struct _packet_info *pinfo, void*)
{
