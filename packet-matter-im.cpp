...
static bool IMSubscriptionFilter_IsValid(struct _packet_info *pinfo, void*)
{
    MatterMessageRecord *msgRec = MatterMessageTracker::FindMessageRecord(pinfo);
    return msgRec != NULL && msgRec->imSubscription != 0;
}

static gchar* IMSubscriptionFilter_BuildFilterString(struct _packet_info *pinfo, void*)
{
    MatterMessageRecord *msgRec = MatterMessageTracker::FindMessageRecord(pinfo);
